<template>
  <div class="contest-page">
    <div class="sub-header">
      <span class="sub-title">作业列表</span>
    ...
    <el-table :data="homeworkList" :header-cell-style="{ textAlign: 'center' }"
        :cell-style="cellStyle" empty-text="暂无作业" v-loading="!finished">
        ...
        <el-table-column prop="playerCnt" label="参与人数" min-width="8%">
          <template #default="scope">
