...
exports.eventList = [
  ...
  'problem.updateSamples',
  'problem.setPublic',
  'problem.setHidden',
  'problem.delete',
  'problem.setType',
  'problem.saveChecker',
  'problem.saveJudgeProfile',
  'problem.saveAsset',
  'problem.renameAsset',
  'problem.downloadAsset',
  'problem.deleteAsset',
  'problem.uploadData',
  'auth.setUserRoles',
  ...
  'discussion.setPublic',
  'discussion.setHidden',
  'discussion.setReplyPublic',
  'discussion.setReplyHidden',
  'discussion.setPermissions',
  'problem.aiGenerate',
  'problem.aiSaveStd',
