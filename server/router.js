...
router.post('/api/contest/recalculateContestRating', contest.recalculateContestRating);
router.post('/api/contest/settleContestRating', contest.settleContestRating);
router.post('/api/contest/previewRating', contest.previewRating);
router.post('/api/contest/previewContestRatingRebuild', contest.previewContestRatingRebuild);
router.post('/api/contest/rebuildContestRatings', contest.rebuildContestRatings);
router.post('/api/contest/cleanupStaleContestRatings', contest.cleanupStaleContestRatings);
router.post('/api/contest/syncContestRatingCache', contest.syncContestRatingCache);
router.post('/api/contest/getRatingSystemStats', contest.getRatingSystemStats);
...
router.post('/api/contest/getRatingChanges', contest.getRatingChanges);
router.post('/api/contest/getUserRatingHistory', contest.getUserRatingHistory);
