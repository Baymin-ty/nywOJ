...
router.post('/api/contest/createTeam', contestTeams.createTeam);
router.post('/api/contest/joinTeam', contestTeams.joinTeam);
router.post('/api/contest/leaveTeam', contestTeams.leaveTeam);
